...
const Playlist: React.FC<PlaylistProps> = ({ name, cover, type = "default", onClick, data }) => {
  return (
    <div
      onClick={onClick}
      className={`group relative ${type === "search" ? "h-36" : "w-full h-16"} rounded-xl hover:shadow-md hover:bg-hovered/40 transition-all duration-500 overflow-hidden cursor-pointer`}
    >
